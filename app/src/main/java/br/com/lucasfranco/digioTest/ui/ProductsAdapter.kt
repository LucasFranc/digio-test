...
class ProductsAdapter(private val products: List<Product>, private val callback: OnProductItemClickCallback) : RecyclerView.Adapter<ProductsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.container.setOnClickListener {
            callback.onClick(products[position])
        }
    }
